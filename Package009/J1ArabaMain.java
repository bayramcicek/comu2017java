...
public class J1ArabaMain {
    public static void main(String[] args){

        String plaka,renk;
        int motorV,hiz,ivme;

        J2Araba a1 = new J2Araba("XY54TR","Brown",120);
        J2Araba a2 = new J2Araba();

        System.out.println("önceki plaka = " + a1.getPlaka() + "\nönceki renk = " + a1.renk + "\nönceki motor hamci = " + a1.motorV);
                                                                                                // motorV static olsaydı
                                                                                                // --> J2Araba.motorV de olurdu.
